...
while True:
    ...
    if previous_mtime != currentzipstat.st_mtime:
        ...
        if zipfile.is_zipfile(currentzippath):
            ...
            currentzip.extractall("/home/site/wwwroot/parsed")
            ...
            json.dump(forJson, open("/home/site/wwwroot/parsed/agency.json","w"))
            ...
            json.dump(forJson, open("/home/site/wwwroot/parsed/stops.json","w"))
            ...
            json.dump(forJson, open("/home/site/wwwroot/parsed/routes.json","w"))
            ...
            json.dump(forJson, open("/home/site/wwwroot/parsed/trips.json","w"))
            ...
            json.dump(forJson, open("/home/site/wwwroot/parsed/stop_times.json","w"))
            ...
            json.dump(forJson, open("/home/site/wwwroot/parsed/calendar.json","w"))
            ...
            json.dump(forJson, open("/home/site/wwwroot/parsed/calendar_dates.json","w"))
            ...
            json.dump(forJson, open("/home/site/wwwroot/parsed/fare_attributes.json","w"))
            ...
            json.dump(forJson, open("/home/site/wwwroot/parsed/fare_rules.json","w"))
            ...
            json.dump(forJson, open("/home/site/wwwroot/parsed/shapes.json","w"))
            ...
            json.dump(forJson, open("/home/site/wwwroot/parsed/shapes.geojson","w"))
            ...
            for stop in stopList:
                ...
                features.append(feature)
            forJson = {"type": "FeatureCollection","crs": { "type": "name", "properties": { "name": "urn:ogc:def:crs:OGC:1.3:CRS84" } }, "features": features }
            json.dump(forJson, open("/home/site/wwwroot/parsed/stops.geojson","w"))
